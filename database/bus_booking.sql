...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 08, 2024 at 03:32 PM
...
CREATE TABLE IF NOT EXISTS `booked` (
  ...
  `SorSL` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '1' COMMENT '1= sleeper 2= semi sleeper',
  `qty` int NOT NULL,
