        ...
        <ul>
          ...
          <li class="drop-down nav-bus nav-location"><a href="#">Maintenance</a>
            <ul>
              ...
              <li><a href="./index.php?page=busdetail">Bus Detalis</a></li>
              <li><a href="./index.php?page=driverdetail">Driver Details</a></li>
              <li><a href="./index.php?page=traveldetail">Travel Details</a></li>
            </ul>
          </li>
